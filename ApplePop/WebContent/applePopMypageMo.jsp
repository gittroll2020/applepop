...
<HTML>
	<HEAD>
		<TITLE> applePopMypageMo</TITLE>
		<META NAME="MypageMo" CONTENT="">
		<meta charset="utf-8">
	...
	<BODY>
			...
			<div class="navdiv">
				...
				<span class="category">
					...
					<table>
						...
						<tr><td><a href="applePopBoard.jsp" target="_self">메이플스토리</a></td></tr>
		...
		<section class="main">
			<article class="article1">
				...
				<tr>
					<th >주소</th>
					<td><input class="inputFont" name="zipcode" size="2" readonly>
						<input class="inputFont" type="button" value="우편번호찾기" size="30"></td>

				</tr>
				<tr>
					<th></th>
					<td>
						<input class="inputFont" name="memberAdres" size="30" placeholder="상세주소를 입력하세요.">
					</td>
				</tr>
				</table>
				...
				<div class="m">
					...
					<!--팝업 자동 닫는 함수는 후에 스크립트에 넣을 예정-->
					<div>
						<span><a href="applePopMypage.jsp" class="buttMo modifyH">수정</a>
					</span>
				</div>
				</div>
			</article>
